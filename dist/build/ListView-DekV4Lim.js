import{j as e,y as x,R as p,f1 as O,a as F,T as b,I as $,C as Ce,r as R,aM as L,s as U,V as Te,a7 as we,fE as ve,bY as Q,a4 as ee,ba as W,fF as ke,_ as te,bF as $e,bM as Me,bN as De,cR as Re,bo as Se,aK as Ae,K as Fe,bO as ne,A as B,df as Ie,X as Ee,w as Le,fl as Oe,bs as Ne,aS as z,fG as Ue,L as oe}from"./strapi-Dwzm6ZvY.js";import{u as M,g as m,C as X,a as H,A as Be,S as Pe,c as Y,b as ie}from"./index-DiyJtD11.js";import{d as Ve,e as J,D as ze,f as Ze,a as We,S as He,v as Ke,s as _e,K as Ge,P as qe,c as Xe,C as Ye}from"./sortable.esm-D_hfOqof.js";import"./index-rwz5BBO6.js";import"./groupBy-IuYWibiv.js";import"./_baseEach-DRD0dxNq.js";import"./sortBy-BGbZuyqP.js";import"./_baseMap-DSnHR6Cv.js";import"./index-M_Btevf4.js";import"./index-BRVyLNfZ.js";const Je=t=>{let{transform:n}=t;return{...n,x:0}},Qe=x(p)`
  position: absolute;
  left: -3.4rem;
  top: 0px;
...
`,Tt=R.memo(({disabled:t,type:n})=>{const{formatMessage:o}=F(),s=Ee(),a=yt(n),l=o({id:"content-type-builder.form.button.configure-view",defaultMessage:"Configure the view"}),i=()=>{if(t)return!1;const y=jt(n);return s(y),!1},{isLoading:c,allowedActions:f}=Le(a);return c||!f.canConfigureView&&!f.canConfigureLayout?null:e.jsx(Ct,{startIcon:e.jsx(Oe,{}),variant:"tertiary",onClick:i,disabled:t,children:l})}),wt=x(oe.Header)`
  ...
  white-space: nowrap;
`,Et=()=>{const{isInDevelopmentMode:t,contentTypes:n,components:o,isLoading:s}=M(),{formatMessage:a}=F(),{trackUsage:l}=ie(),{contentTypeUid:i,componentUid:c}=Ne(),{onOpenModalAddComponentsToDZ:f,onOpenModalAddField:y,onOpenModalEditSchema:k}=H(),r=i?n[i]:c?o[c]:null;if(s)return null;if(!r){const j=Object.values(n).filter(C=>C.visible===!0&&!C.plugin).map(C=>C.uid).sort();return j.length>0?e.jsx(z,{to:`/plugins/content-type-builder/content-types/${j[0]}`}):e.jsx(z,{to:"/plugins/content-type-builder/content-types/create-content-type"})}if(i&&r.modelType==="contentType"&&r.visible===!1)return e.jsx(z,{to:"/plugins/content-type-builder/content-types/create-content-type",replace:!0});const d="plugin"in r&&r?.plugin!==void 0,u=i?"contentType":"component",T=r?.info?.displayName??"",w=t&&!d,S=j=>{f({dynamicZoneTarget:j,targetUid:r.uid})},D=()=>{if("kind"in r){r?.kind==="collectionType"&&l("willEditNameOfContentType"),r?.kind==="singleType"&&l("willEditNameOfSingleType"),k({modalType:u,forTarget:u,targetUid:r.uid,kind:r?.kind});return}k({modalType:u,forTarget:u,targetUid:r.uid})},I=a({id:m("table.button.no-fields"),defaultMessage:"Add new field"}),A=a({id:m("button.attributes.add.another"),defaultMessage:"Add another field"}),g=r.status==="REMOVED",h=t&&e.jsxs(b,{gap:2,children:[e.jsx(Tt,{type:r,disabled:r.status==="NEW"||g},"link-to-cm-settings-view"),e.jsx(B,{startIcon:e.jsx(te,{}),variant:"tertiary",onClick:D,disabled:!w||g,children:a({id:"app.utils.edit",defaultMessage:"Edit"})}),e.jsx(B,{startIcon:e.jsx(L,{}),variant:"secondary",minWidth:"max-content",onClick:()=>{y({forTarget:u,targetUid:r.uid})},disabled:g,children:r.attributes.length===0?I:A})]});return e.jsxs(e.Fragment,{children:[e.jsx(ne.contentTypeBuilder.Introduction,{children:e.jsx(p,{})}),g&&e.jsx(b,{background:"danger100",justifyContent:"center",padding:4,children:e.jsxs(b,{gap:2,children:[e.jsx(Ue,{fill:"danger600",height:"2rem",width:"2rem"}),e.jsx($,{children:a({id:m("table.warning.deleted"),defaultMessage:"This {kind} has been deleted"},{kind:r.modelType==="contentType"?"Content Type":"Component"})})]})}),e.jsx(wt,{id:"title",primaryAction:h,title:W(T)}),e.jsx(oe.Content,{children:e.jsx(p,{background:"neutral0",shadow:"filterShadow",hasRadius:!0,overflow:"auto",borderColor:"neutral150",children:e.jsx(ue,{type:r,addComponentToDZ:S,isMain:!0})})})]})};export{Et as default};
